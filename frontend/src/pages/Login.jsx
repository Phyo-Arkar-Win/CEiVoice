        ...
        <>
            <div className='min-h-screen bg-background '>
                ...
                <div className='py-6 flex justify-center items-center mt-16'>
                    <div className='bg-surface w-96 rounded-2xl shadow-lg p-8'>
                        ...
                        <form onSubmit={handleManualLogin}>
                            ...
                            <button
                                type='submit'
                                className='w-full mt-0.5 bg-primary-500 hover:bg-primary-600 cursor-pointer text-white py-3 rounded-2xl font-medium mb-4'
                            >
                                Login
                            </button>
                        </form>
